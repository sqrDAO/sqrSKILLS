...
below — is not resolvable at the portal's document paths. Detail marked *(annex)* comes from
the signed annex alone. The city portal's own announcement carries DNC-Chain, Sở KH&CN's lead
...
- **The annexed Đề án (Tier 1 by signature, not publicly resolvable):** the scheme text promulgated with 2728/QĐ-UBND, signed 24 Jun 2026 and carrying the government CA. It is the only source for the SP1–SP10 list, the four-tier table, DNC-Chain's three constraints and the 55/2024/NQ-HĐND citation. Not retrievable at the portal's `documents/37638/164901/` paths as of 4 September 2026; label annex-only detail as such rather than citing a URL for it.
