...
- **"6-month trigger" for investor penalties:** The penalty for domestic investors trading on unlicensed platforms (Article 9) is **not immediately enforceable** on 1 Sep 2026. Per Resolution 05, this specific penalty only applies **six months after the Ministry of Finance issues the first operating license** to a domestic crypto exchange. As no licenses have yet been granted, domestic investors have a grace period to migrate from offshore platforms.
- **Implementation guidance:** The MoF, SSC, and State Bank are the primary enforcement bodies. Supporting guidance is found in **Circular 89/2026/TT-BTC** (tax administration), **Circular 90/2026/TT-BTC** (e-identification and tax registration for digital businesses), and **Circular 39/2026/TT-NHNN** (use of VND/foreign currency accounts).
