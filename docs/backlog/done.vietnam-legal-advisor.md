...
skill, with portable resources and without assuming the user's company identity; correct pre-merge review findings.
...
## Acceptance
- [x] All nine source files are imported with version 0.1.1 and advisory tools.
...
- [x] NOT: exhaustive legal-content refresh or global installation.
...
## Notes
- Source: user-supplied `vietnam-legal-advisor.skill` archive.
- User requested this addition on a separate branch and another PR.
- User approved completion and merge after review fixes on 2026-09-11.
...
- Review fixes: inclusive withholding boundary and applicability, deduction arithmetic,
  VAT placeholders, no circular crypto handoff, consistent missing-identity handling,
  preservation of signed originals, measured seal space, and renderer verification.
